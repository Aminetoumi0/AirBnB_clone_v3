...
Return:
Exit status is # of errors, 0 on Success
Reference
...
def __analyse(file_path):
    """Start an analyse of a file and print the result
    """
    nb_errors = 0
    try:
        result = None
...
def __files_loop():
    """Loop that analyse for each file from input arguments
    """
    nb_errors = 0
...
if __name__ == "__main__":
    ...
    """execute test, then exit. Exit status = # of errors (0 on success)
    """
